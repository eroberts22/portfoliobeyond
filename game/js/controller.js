...
function gameController() {
    ...
    function createObjects()  {
        var o;
        objects.push(CreateBackground("game/img/assets/space-planets-back.png", -2.5, 0));
        objects.push(CreateBackground("game/img/assets/space-planets-front.png", -7.5, 0));
    ...
    function generateWinScreen() {
        ...
        objects.push(CreateEnd("game/img/assets/win.png"));
    ...
    function generateLoseScreen() {
        // remove all objects from game except background
        objects = objects.filter(function(i){return i.type === "background";});
        objects.push(CreateEnd("game/img/assets/lose.png"));
